...
class EmptyTabMongoQuery extends StatelessWidget {
  const EmptyTabMongoQuery({super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Create collection first to start writing and executing queries',
          ...
          Row(
            ...
            children: [
              ...
              Flexible(
                child: Text(
                  'Navigate to "Collection" tab to add collection ',
